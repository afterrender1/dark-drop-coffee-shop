      ...
      <div className="mx-auto max-w-7xl px-6 pt-24 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24 items-start">
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-neutral-400 text-sm leading-relaxed max-w-sm font-light">
              Architecting a new standard for the modern ritual. Every bean is a
              data point; every roast is a protocol.
            </p>
          </div>

          <div className="lg:col-span-7 w-full">
            <div className="space-y-4 max-w-md lg:ml-auto">
              <span className="text-[10px] font-mono text-neutral-400 uppercase tracking-[0.5em]">
                The Newsletter Protocol
              </span>
              <form className="relative group">
                ...
                <button className="absolute right-0 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-amber-500 transition-all flex items-center gap-2 group/btn">
                  <span className="text-[9px] font-mono opacity-0 group-hover/btn:opacity-100 transition-opacity">
                    CONNECT
                  </span>
                  <ArrowRight
                    size={20}
        ...
        <div className="flex flex-wrap gap-x-16 gap-y-8 py-12 border-y border-white/5 mb-12">
          {navLinks.map((link) => (
            ...
            >
              <span className="text-amber-500/40 font-mono text-[10px] group-hover:text-amber-500 transition-colors">
          ...
          <div className="flex items-center gap-8 order-1 md:order-2">
            {[
              ...
              >
                <social.icon
                  size={14}
                  className="text-neutral-700 group-hover:text-amber-500 transition-colors"
                />
